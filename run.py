...
"""
jsub -q qgpu -J yastfn -m gpu01 -e error.txt -o output.txt python run.py --lr 2e-4 --num_workers 18 --batch_size 36 --epochs 500 --cuda --ngpu 2 --image_size 2040 1720 --save_dir out --data_dir data

jsub -q qgpu -J yastfn -m gpu01 -e error.txt -o output.txt python run.py --lr 2e-4 --num_workers 18 --batch_size 36 --epochs 500 --cuda --ngpu 2 --image_size 2720 3200 --patch_size 1360 1600 --save_dir out --data_dir data
"""
