...
"""
jsub -q qgpu -J ganstfm -e error.txt -o output.txt python run.py --lr 2e-4 --num_workers 28 --batch_size 28 --epochs 500 --cuda --ngpu 4 --image_size 2040 1720 --save_dir out --data_dir data

jsub -q qgpu -J ganstfm -e error.txt -o output.txt python run.py --lr 2e-4 --num_workers 28 --batch_size 28 --epochs 500 --cuda --ngpu 4 --image_size 2720 3200 --patch_size 1360 1600 --save_dir out --data_dir data
"""
